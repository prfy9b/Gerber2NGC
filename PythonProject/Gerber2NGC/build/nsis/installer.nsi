...
!define INSTALLER_NAME "main_1.0.exe"
...
!define MULTIUSER_INSTALLMODE_INSTDIR "main"
...
Section "!${PRODUCT_NAME}" sec_app
  ...
  SetOutPath "%HOMEDRIVE%\%HOMEPATH%"
    CreateShortCut "$SMPROGRAMS\main.lnk" "$INSTDIR\Python\pythonw.exe" \
      '"$INSTDIR\main.launch.pyw"' "$INSTDIR\glossyorb.ico"
  SetOutPath "$INSTDIR"
...
Section "Uninstall"
  ...
  ; Uninstall files
    ...
    Delete "$INSTDIR\main.launch.pyw"
  ; Uninstall directories
    RMDir /r "$INSTDIR\Python"

  ; Uninstall shortcuts
      Delete "$SMPROGRAMS\main.lnk"
  RMDir $INSTDIR
